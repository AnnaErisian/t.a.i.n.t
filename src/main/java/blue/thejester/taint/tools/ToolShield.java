...
//Shield: battle sign but not a sign. Largeplate, binding. Damage Potential 0.5, Attack Speed 1.1, Durability Mod 1.3, DMG Cutoff 10
public class ToolShield extends TinkerToolCore {


    private static final float DURABILITY_MODIFIER = 1.3f;

    public ToolShield() {
        super(PartMaterialType.head(TinkerTools.largePlate),
        ...
        setTranslationKey("shield").setRegistryName("shield");
    }
